                ...
                <div class="col-12 col-lg-5 mx-auto p-2">
                    <div class="row budget-item g-3">
                        ...
                        <div class="col-12">
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('budget.item.update', ['item_id' => $item['id']]) }}">
                            ...
                            @else
                            <a class="btn btn-sm btn-dark" href="{{ route('budget.item.confirm-enable', ['item_id' => $item['id']]) }}">
                            ...
                            @endif
                            <a class="btn btn-sm btn-danger" href="{{ route('budget.item.confirm-delete', ['item_id' => $item['id']]) }}">
