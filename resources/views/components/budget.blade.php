<div class="budget">
    ...
    <div class="row">
        <div class="col-12 text-end">
            ...
            <div class="btn-group" role="group">
                ...
                <a class="btn btn-sm btn-outline-primary" href="{{ route('budget.account.create') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                    </svg>
                    New Account
    ...
    @if ($has_budget === false)
        <div class="row mt-3 p-3">
            ...
            <p class="mb-0">
                ...
                @else
                    <a class="btn btn-sm btn-outline-primary" href="{{ route('demo') }}">
                    ...
                    <a class="btn btn-sm btn-outline-primary" href="{{ route('start') }}">
    ...
    <div class="row mt-3 balances">
        ...
        <div class="col-6">
            ...
            <div class="balance">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('budget.account.update', ['account_id' => $__account->id()]) }}">
