...
<div class="col-12">
    <a class="btn btn-sm btn-outline-primary" href="{{ route('budget.item.view', ['item_id' => $item['id'], 'action' => 'adjust', 'item-month' => $item_month, 'item-year' => $item_year]) }}" title="Adjust budget item amount">
